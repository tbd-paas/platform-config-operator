...
// MutateClusterRoleIdentityOperatorProxyRole mutates the ClusterRole resource with name identity-operator-proxy-role.
func MutateClusterRoleIdentityOperatorProxyRole(
