...
// MutateRoleNamespaceIdentityOperatorLeaderElectionRole mutates the Role resource with name identity-operator-leader-election-role.
func MutateRoleNamespaceIdentityOperatorLeaderElectionRole(
