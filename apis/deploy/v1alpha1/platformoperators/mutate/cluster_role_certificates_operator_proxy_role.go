...
// MutateClusterRoleCertificatesOperatorProxyRole mutates the ClusterRole resource with name certificates-operator-proxy-role.
func MutateClusterRoleCertificatesOperatorProxyRole(
