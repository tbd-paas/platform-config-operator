...
const samplePlatformConfig = `apiVersion: deploy.platform.tbd.io/v1alpha1
kind: PlatformConfig
metadata:
...
const samplePlatformConfigRequired = `apiVersion: deploy.platform.tbd.io/v1alpha1
kind: PlatformConfig
metadata:
  name: platformconfig-sample
spec:
...
func Generate(
	workloadObj deployv1alpha1.PlatformConfig,
...
func GenerateForCLI(workloadFile []byte) ([]client.Object, error) {
	var workloadObj deployv1alpha1.PlatformConfig
...
var CreateFuncs = []func(
	*deployv1alpha1.PlatformConfig,
	workload.Reconciler,
	*workload.Request,
) ([]client.Object, error){
	CreateNamespacePlatformCertificatesNamespace,
	CreateNamespacePlatformIdentityNamespace,
	CreateCertManagerConfig,
	CreateTrustManagerConfig,
	CreateAWSPodIdentityWebhookConfig,
}
...
func ConvertWorkload(component workload.Workload) (*deployv1alpha1.PlatformConfig, error) {
	p, ok := component.(*deployv1alpha1.PlatformConfig)
	if !ok {
		return nil, deployv1alpha1.ErrUnableToConvertPlatformConfig
	}
