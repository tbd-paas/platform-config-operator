...
// MutateNamespacePlatformCertificatesNamespace mutates the Namespace resource with name parent.Spec.Platform.Certificates.Namespace.
func MutateNamespacePlatformCertificatesNamespace(
