...
// MutateNamespacePlatformIdentityNamespace mutates the Namespace resource with name parent.Spec.Platform.Identity.Namespace.
func MutateNamespacePlatformIdentityNamespace(
