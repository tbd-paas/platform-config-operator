...
// packages (e.g. mutate).
const (
	CRDCertificatescapabilitiesCapabilitiesPlatformTbdIo                = "certificatescapabilities.capabilities.platform.tbd.io"
	...
	CRDIdentitycapabilitiesCapabilitiesPlatformTbdIo                    = "identitycapabilities.capabilities.platform.tbd.io"
