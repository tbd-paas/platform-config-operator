...
// CreateCRDCertificatescapabilitiesCapabilitiesPlatformTbdIo creates the CustomResourceDefinition resource with name certificatescapabilities.capabilities.platform.tbd.io.
func CreateCRDCertificatescapabilitiesCapabilitiesPlatformTbdIo(
	...
	var resourceObj = &unstructured.Unstructured{
		Object: map[string]interface{}{
			...
			"metadata": map[string]interface{}{
				...
				"name": "certificatescapabilities.capabilities.platform.tbd.io",
			},
			"spec": map[string]interface{}{
				"group": "capabilities.platform.tbd.io",
				"names": map[string]interface{}{
					"kind":     "CertificatesCapability",
					"listKind": "CertificatesCapabilityList",
					"plural":   "certificatescapabilities",
					"singular": "certificatescapability",
				},
				"scope": "Cluster",
				"versions": []interface{}{
					map[string]interface{}{
						...
						"schema": map[string]interface{}{
							"openAPIV3Schema": map[string]interface{}{
								"description": "CertificatesCapability is the Schema for the certificatescapabilities API.",
...
More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds`,
									...
									"spec": map[string]interface{}{
										"description": "CertificatesCapabilitySpec defines the desired state of CertificatesCapability.",
										"properties": map[string]interface{}{
	...
	Memory requests to use for cert-manager webhook deployment.`,
											...
											"namespace": map[string]interface{}{
												"description": "	Namespace to use where underlying certificates capability will be deployed.",
												"type":        "string",
											},
											"trustManager": map[string]interface{}{
												"properties": map[string]interface{}{
													"controller": map[string]interface{}{
														"properties": map[string]interface{}{
															"image": map[string]interface{}{
	...
	Memory requests to use for trust-manager controller deployment.`,
									...
									"status": map[string]interface{}{
										"description": "CertificatesCapabilityStatus defines the observed state of CertificatesCapability.",
										"properties": map[string]interface{}{
...
of the controller reconciliation loop.`,
	...
	return mutate.MutateCRDCertificatescapabilitiesCapabilitiesPlatformTbdIo(resourceObj, parent, reconciler, req)
}
...
// +kubebuilder:rbac:groups=capabilities.platform.tbd.io,resources=certificatescapabilities,verbs=create;delete;get;list;patch;update;watch
// +kubebuilder:rbac:groups=capabilities.platform.tbd.io,resources=certificatescapabilities/status,verbs=get;patch;update
	...
	var resourceObj = &unstructured.Unstructured{
		Object: map[string]interface{}{
			...
			"rules": []interface{}{
				...
				map[string]interface{}{
					"apiGroups": []interface{}{
						"capabilities.platform.tbd.io",
					},
					"resources": []interface{}{
						"certificatescapabilities",
					},
					"verbs": []interface{}{
						"create",
						"delete",
				...
				map[string]interface{}{
					...
					"resources": []interface{}{
						"certificatescapabilities/status",
					},
					"verbs": []interface{}{
						"get",
						"patch",
