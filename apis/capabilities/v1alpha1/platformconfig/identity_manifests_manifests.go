...
// CreateCRDIdentitycapabilitiesCapabilitiesPlatformTbdIo creates the CustomResourceDefinition resource with name identitycapabilities.capabilities.platform.tbd.io.
func CreateCRDIdentitycapabilitiesCapabilitiesPlatformTbdIo(
	...
	var resourceObj = &unstructured.Unstructured{
		Object: map[string]interface{}{
			...
			"metadata": map[string]interface{}{
				...
				"name": "identitycapabilities.capabilities.platform.tbd.io",
			},
			"spec": map[string]interface{}{
				"group": "capabilities.platform.tbd.io",
				"names": map[string]interface{}{
					"kind":     "IdentityCapability",
					"listKind": "IdentityCapabilityList",
					"plural":   "identitycapabilities",
					"singular": "identitycapability",
				},
				"scope": "Cluster",
				"versions": []interface{}{
					map[string]interface{}{
						...
						"schema": map[string]interface{}{
							"openAPIV3Schema": map[string]interface{}{
								"description": "IdentityCapability is the Schema for the identitycapabilities API.",
...
More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds`,
									...
									"spec": map[string]interface{}{
										"description": "IdentityCapabilitySpec defines the desired state of IdentityCapability.",
										"properties": map[string]interface{}{
											"namespace": map[string]interface{}{
												"description": "	Namespace to use where underlying identity capability will be deployed.",
												"type":        "string",
											},
										},
										"type": "object",
									...
									"status": map[string]interface{}{
										"description": "IdentityCapabilityStatus defines the observed state of IdentityCapability.",
										"properties": map[string]interface{}{
...
of the controller reconciliation loop.`,
	...
	return mutate.MutateCRDIdentitycapabilitiesCapabilitiesPlatformTbdIo(resourceObj, parent, reconciler, req)
}
...
// +kubebuilder:rbac:groups=capabilities.platform.tbd.io,resources=identitycapabilities,verbs=create;delete;get;list;patch;update;watch
// +kubebuilder:rbac:groups=capabilities.platform.tbd.io,resources=identitycapabilities/status,verbs=get;patch;update
