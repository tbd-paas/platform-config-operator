...
// MutateRoleNamespaceCertificatesOperatorLeaderElectionRole mutates the Role resource with name certificates-operator-leader-election-role.
func MutateRoleNamespaceCertificatesOperatorLeaderElectionRole(
