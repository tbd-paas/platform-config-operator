...
// MutateClusterRoleIdentityOperatorManagerRole mutates the ClusterRole resource with name identity-operator-manager-role.
func MutateClusterRoleIdentityOperatorManagerRole(
