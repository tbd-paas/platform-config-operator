...
// MutateClusterRoleCertificatesOperatorManagerRole mutates the ClusterRole resource with name certificates-operator-manager-role.
func MutateClusterRoleCertificatesOperatorManagerRole(
