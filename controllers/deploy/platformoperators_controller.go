...
func NewPlatformOperatorsReconciler(mgr ctrl.Manager) *PlatformOperatorsReconciler {
	return &PlatformOperatorsReconciler{
		Name:         "PlatformOperators",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("PlatformOperators-Controller"),
		FieldManager: "PlatformOperators-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("deploy").WithName("PlatformOperators"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
		Manager:      mgr,
	}
...
// +kubebuilder:rbac:groups=deploy.platform.tbd.io,resources=platformoperators,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=deploy.platform.tbd.io,resources=platformoperators/status,verbs=get;update;patch
...
func (r *PlatformOperatorsReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &deployv1alpha1.PlatformOperators{}
...
func (r *PlatformOperatorsReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, err := platformoperators.ConvertWorkload(req.Workload)
	if err != nil {
		return nil, err
	}

	return platformoperators.Generate(*component, r, req)
}
...
func (r *PlatformOperatorsReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.PlatformOperatorsCheckReady(r, req)
}
...
func (r *PlatformOperatorsReconciler) Mutate(
	...
	return mutate.PlatformOperatorsMutate(r, req, object)
}
...
func (r *PlatformOperatorsReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	baseController, err := ctrl.NewControllerManagedBy(mgr).
		...
		For(&deployv1alpha1.PlatformOperators{}).
		Build(r)
	if err != nil {
