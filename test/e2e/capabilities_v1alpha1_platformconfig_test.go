...
func capabilitiesv1alpha1PlatformConfigChildrenFuncs(tester *E2ETest) error {
...
func capabilitiesv1alpha1PlatformConfigNewHarness(namespace string) *E2ETest {
	return &E2ETest{
		namespace:          namespace,
		unstructured:       &unstructured.Unstructured{},
		workload:           &capabilitiesv1alpha1.PlatformConfig{},
		sampleManifestFile: "../../config/samples/capabilities_v1alpha1_platformconfig.yaml",
		getChildrenFunc:    capabilitiesv1alpha1PlatformConfigChildrenFuncs,
		logSyntax:          "controllers.capabilities.PlatformConfig",
	}
}

func (tester *E2ETest) capabilitiesv1alpha1PlatformConfigTest(testSuite *E2EComponentTestSuite) {
...
func (testSuite *E2EComponentTestSuite) Test_capabilitiesv1alpha1PlatformConfig() {
	tester := capabilitiesv1alpha1PlatformConfigNewHarness("")
	tester.capabilitiesv1alpha1PlatformConfigTest(testSuite)
}
